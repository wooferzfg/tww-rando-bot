...
DEV_PERMALINKS = OrderedDict([
    ("miniblins", "eJxLSS2LL0nMy8o31jPUMzTQM423NLIwtUwzYHBkOLshQYKdgY2DiQEOGOEsBRkGhhYFBgUIT/MMQwOHctID4SYBBgYOFQcGJkWgUi6oUgYBAOCrDuQ="),  # noqa: E501
    ...
    ("miniblins-s2", "eJxLSS2LL0nMy8o31jPUMzTQM423NLIwtUwzYHBk8DVwYCASaPYwNHCoKD0QbgpgYOBQcWBgUmRkYOCCSQsAAEyFDDU="),
    ("miniblins-s1", "eJxLSS2LL0nMy8o31jPUMzTQM423NLIwtUwzYHBkiDRwYAADKIXE4HFkYBAQ4GCE8TV7GBo4TJQfCDcFMDBwqDgwMCkC5bhg0gIAhasNSA=="),  # noqa: E501
])
DEV_DEFAULT = ["miniblins"]

DEV_SL_PERMALINKS = OrderedDict([
    ("miniblins", "eJxLSS2LL0nMy8o31jPUMzTQM423NLIwtUwzYHBkOLshQYKdgY2DiQEOGOEsBRkGhhYFBgUIT/MMQwOHctID4SYBBgYOFQcGJkWgUi6oUgYGAOCbDtQ="),  # noqa: E501
    ("miniblins-s3", "eJxLSS2LL0nMy8o31jPUMzTQM423NLIwtUwzYHBk6DRIEGBnYONgwAoEGBhY4BzNHoYGDpWkB8JNQGEOFQcGJkVGBgYuuDwAddAMug=="),  # noqa: E501
    ("miniblins-s2", "eJxLSS2LL0nMy8o31jPUMzTQM423NLIwtUwzYHBk8DVwYCASaPYwNHCoKD0QbgpgYOBQcWBgUmRkYOCCywMATHUMJQ=="),
...
PERMALINK_PREFIXES = ["MS4", "eJw", "eJx", "UlM"]
