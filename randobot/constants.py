...
DEV_PERMALINKS = OrderedDict([
    ("miniblins", "eJxLSS2LL0nMy8o31jPUMzTQM483MUuzSDUwZHBkOLshgYGhwZCFQcJBgAETMGIKCUSAKQcBDgYOCIvLGEwrHOqQ+NGiwMLAwMTIxKIgIMTAsACqR4mBAwBzNhAm"),  # noqa: E501
    ("miniblins-s3", "eJxLSS2LL0nMy8o31jPUMzTQM483MUuzSDUwZHBk6DRIYGBgMGRhkHBgIBI4IJFgFpcymFZg6pT40aLAwsDAxMjEoiAgxMCwAK6IAwDEjw2Y"),  # noqa: E501
    ("miniblins-s2", "eJxLSS2LL0nMy8o31jPUMzTQM483MUuzSDUwZHBk8DVwYKAQOHApg2kFpk6OXy0KIgwMTIxMLAoCQgwMC6BKmBg4AFBSDDM="),  # noqa: E501
    ("miniblins-s1", "eJxLSS2LL0nMy8o31jPUMzTQM483MUuzSDUwZHBkiDRwYEAABQYUwMSABgIEGFjA4goMDXC1DlzKCWDNTGc5frUoiADlGZlYFASEGBgWwHVyAACxOA4p"),  # noqa: E501
])
DEV_DEFAULT = ["miniblins"]

DEV_SL_PERMALINKS = OrderedDict([
    ("miniblins", "eJxLSS2LL0nMy8o31jPUMzTQM483MUuzSDUwZHBkOLshgYGhwZCFQcJBgAETMGIKCUSAKQcBDgYOCIvLGEwrHOqQ+NGiwMLAwMTIxKIgIMTAsACqR4mBAQBzLhAe"),  # noqa: E501
    ("miniblins-s3", "eJxLSS2LL0nMy8o31jPUMzTQM483MUuzSDUwZHBk6DRIYGBgMGRhkHBgIBI4IJFgFpcymFZg6pT40aLAwsDAxMjEoiAgxMCwAKELAMSHDZA="),  # noqa: E501
    ("miniblins-s2", "eJxLSS2LL0nMy8o31jPUMzTQM483MUuzSDUwZHBk8DVwYKAQOHApg2kFpk6OXy0KIgwMTIxMLAoCQgwMC6BKmBgYAFBKDCs="),  # noqa: E501
    ("miniblins-s1", "eJxLSS2LL0nMy8o31jPUMzTQM483MUuzSDUwZHBkiDRwYEAABQYUwMSABgIEGFjA4goMDXC1DlzKCWDNTGc5frUoiADlGZlYFASEGBgWILQCALEwDiE="),  # noqa: E501
])
